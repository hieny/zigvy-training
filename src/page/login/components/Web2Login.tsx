  ...
  return (
    <div className="login_v2">
      <button>
        ...
        <span className="social_name">Login with Facebook</span>
      </button>
      <button>
        <span>
          <svg
        ...
        <span className="social_name">Login with Google</span>
      </button>
      <button>
        <span>
          <svg
        ...
        <span className="social_name">Login with Apple</span>
      </button>
      <button>
        <span>
          <svg
        ...
        <span className="social_name">Login with email</span>
      </button>
    </div>
  );
}

  ...
  return (
    <div className="footer_info">
      <div className="footer_info_content">
        {/* aaa */}
        <div className="footer_info_content_policy">
          <span>© 2024 Airbnb, Inc.</span>
          <span className="dot_divide">.</span>
          <span>Terms</span>
          <span className="dot_divide">.</span>
          <span>Sitemap</span>
          <span className="dot_divide">.</span>
        ...
        {/* aaa */}
        <div className="footer_info_content_social">
          <span>
            <svg
          ...
          <span>$ USD</span>
          <div className="footer_info_content_social_icon">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
